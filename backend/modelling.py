...
# Kolom KA asli yang dipakai rule-based
KA_RULE_COLS = [
...
# Kolom yield asli yang dipakai rule-based
...
def run_modelling(
    ...
    """
    Jalankan seluruh pipeline modelling
    ...
    # Helper: ambil kolom proba defect
    ...
    # Hanya train jika model belum ada, jika sudah di-load dari disk, maka dilewatkan.
    if not _all_models_exist:
        if single_class:
